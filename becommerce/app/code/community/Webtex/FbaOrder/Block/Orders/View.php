 ...
 */
class Webtex_FbaOrder_Block_Orders_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        return Mage::helper('wford')->__(
            "Amazon fulfillment order #'%s'",
            $this->escapeHtml($this->getFOrder()->getId())
        );
    }
